...
import java.util.*;
 ...
 public class Assignment2Tester {
    ...
    void testVowelAndConsonantCounter() {
        ...
        // Assuming StudentGUI is the class that creates the GUI
        StudentGUI studentGUI = new StudentGUI();
        JFrame frame = studentGUI.getFrame(); // Method to get the JFrame from StudentGUI
        JTextArea textArea = studentGUI.getTextArea(); // Method to get the JTextArea from StudentGUI
        JLabel vowelLabel = studentGUI.getVowelLabel(); // Method to get the JLabel for vowels
        JLabel consonantLabel = studentGUI.getConsonantLabel(); // Method to get the JLabel for consonants
